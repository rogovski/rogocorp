+++
categories = []
tags = ["mathematics", "optimization", "python"]
description = "Linear Programming with Cvxopt"
menu = ""
banner = ""
images = []
date = "2017-07-19T17:23:21-04:00"
title = "linear programming"
draft = true
+++

the wikipedia entry for Linear Programming has an example problem setup.
show problem definition
we need to transform this problem definition into a different but equivalent problem definition

lets look at cvxopt's api docs for linear programming.
show lp primal form def
